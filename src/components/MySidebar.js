...
class MySidebar extends Component {
  ...
  render() {
    ...
    const { dropdownActiveItem, sidebarActiveItem, setSidebarActiveItem, 
      sidebarVisible, setSidebarVisible, setRptStep, getRptStep } 
        ...
        {dropdownActiveItem === 'production' ?
          <Sidebar.Pushable as={Segment} attached='bottom'>
            ...
            <Sidebar.Pusher dimmed={sidebarVisible} style={divStyle} >
              {getRptStep() === 1 ? <Routes childProps={childProps} /> : ''}
