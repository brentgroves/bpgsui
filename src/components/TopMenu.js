...
class TopMenu extends Component {
  ...
  render() {
    const { isAuthenticated, sidebarVisible, setSidebarVisible,
      topmenuActiveItem, dropdownActiveItem, pwdDropdownActiveItem, signupDropdownActiveItem,
      setRptStep, rmReport, jsreport, setDropdownActiveItem, setSignupDropdownActiveItem,
      setPwdDropdownActiveItem, setTopmenuActiveItem, handleLogout } = this.props.childProps
            ...
            >
              <Dropdown.Menu>
                <Dropdown.Item
                  ...
                  <span id='pwdDropDownChangePassword' className='text'>Password Change</span>
                </Dropdown.Item>
                <Dropdown.Item
                  key='19'
                  name='forgotPassword'
                  ...
                  <span id='pwdDropDownForgotPassword' className='text'>Forgotten password</span>
                </Dropdown.Item>
              </Dropdown.Menu>
            </Dropdown>
